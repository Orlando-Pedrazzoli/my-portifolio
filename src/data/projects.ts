...
export const projects: Project[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        pt: '👨‍⚕️ Painel admin: CRUD de pacientes com tabelas ordenáveis, busca e input masking (NIF, telefone PT)',
        en: '👨‍⚕️ Admin panel: patient CRUD with sortable tables, search and input masking (NIF, PT phone)',
      },
      {
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        pt: '🗂️ Portfólio com projetos reais e processo de trabalho step-by-step',
        en: '🗂️ Portfolio with real projects and step-by-step work process',
      },
      {
